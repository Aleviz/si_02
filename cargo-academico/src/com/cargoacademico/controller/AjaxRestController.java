...
public class AjaxRestController {
	...
	public ResponseEntity<List<EscuelaEspejo>> obtenerCampus(@PathVariable("nameCampus") String nameCampus) {
		...
		System.out.println("escp  "+escEList.size()  );
		try {
...
//			escEsp.setFacultad(escuelas.get(i).getFacultad().getFacultad());
	...
	@RequestMapping(value = "obtenerCarrera/{nameCarrera}", method = RequestMethod.GET, produces = { MimeTypeUtils.APPLICATION_JSON_VALUE })
