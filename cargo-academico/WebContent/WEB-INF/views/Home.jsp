			...
			<div class="row h-100">
				<div class="col-12 h-100">
					<div
								...
								<div class="container">
									...
									<div class="calling-info">
										<div class="call-center">
											<a href="tel:+654563325568889"><i
												class="icon-telephone-2"></i> <span>(503)${campusdir.telefono}</span></a>
										</div>
									</div>
									</nav>
								</div>
									...
									<div class="row h-100 align-items-center">
										<div class="col-12">
											<div class="hero-slides-content">
												<h4 data-animation="fadeInUp" data-delay="100ms">All
													the courses you need</h4>
												<h2 data-animation="fadeInUp" data-delay="400ms">
													Wellcome to our <br>Online University
												</h2>
												<a href="#" class="btn academy-btn"
													data-animation="fadeInUp" data-delay="700ms">Read More</a>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="col-12 col-sm-6 col-lg-4">
										<div
											...
											<div class="course-content">
												...
												<p>Cras vitae turpis lacinia, lacinia la cus non,
													fermentum nisi.</p>
											</div>
										</div>
									</div>
						...
						<div
							class="testimonials-area section-padding-100 bg-img bg-overlay"
							style="background-image: url(<%=request.getContextPath()%>/res/design/img/bg-img/bg-2.jpg);">
							<div class="container">
								<div class="row">
									<div class="col-12">
										<div
											class="section-heading text-center mx-auto white wow fadeInUp"
											data-wow-delay="300ms">
								...
								<div class="row">
									...
									<div class="col-12 col-md-6">
										<div
											class="single-testimonial-area mb-100 d-flex wow fadeInUp"
											data-wow-delay="400ms">
											...
											<div class="testimonial-content">
												...
												<p>Etiam nec odio vestibulum est mattis effic iturut
									...
									<div class="col-12 col-md-6">
										<div
											...
											<div class="testimonial-content">
												...
												<p>Retiam nec odio vestibulum est mattis effic iturut
													magna. Pellentesque sit amet tellus blandit. Etiam nec odio
													vestibulum est mattis effic iturut magna. Pellentesque sit
													am et tellus blandit. Etiam nec odio vestibul.</p>
												<h6>
										...
										<div
											...
											<div class="testimonial-content">
												...
												<p>Nec odio vestibulum est mattis effic iturut magna.
													...
													vestibul. Etiam nec odio vestibulum est mat tis effic
													iturut magna. Pellentesque sit amet tellus blandit. Etiam
													nec odio ves tibul.</p>
												<h6>
									...
									<div class="col-12 col-md-6">
										<div
											...
											<div class="testimonial-content">
												...
												<p>Vestibulum est mattis effic iturut magna.
													Pellentesque sit am et tellus blandit. Etiam nec odio
													vestibul. Etiam nec odio vestibu lum est mat tis effic
													iturut magna. Pellentesque sit amet tellus blandit. Etiam
													nec odio ves tibul. Etiam nec odio vestibulum est mat tis
													effic iturut magnaNec odio vestibulum est mattis effic
													iturut magna.</p>
												<h6>
										...
										<div class="col-12 col-lg-6">
											<div
												...
												<div class="popular-course-content">
													...
													<p>Cras vitae turpis lacinia, lacinia lacus non,
														fermentum nisi. Donec et sollicitudin est, in euismod.</p>
								...
								<div class="row">
									...
									<div class="col-12 col-sm-6 col-lg-3">
										<div class="footer-widget mb-100">
											...
											<p>La Universidad nacional de Innovacion Tecnologica es
												la institución de educación superior más grande y antigua de
												la República de El Salvador.</p>
